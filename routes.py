...
def setup_routes(app: Flask):
    ...
    app.add_url_rule("/about/write", view_func=views.write_notice, methods=["GET", "POST"])
    app.add_url_rule("/about/edit", view_func=views.write_notice, methods=["GET", "POST"])
    ...
    app.add_url_rule("/notices/<int:no>/delete", view_func=views.delete_notice, methods=["DELETE"])
